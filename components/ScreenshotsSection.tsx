        ...
        <div className="relative">
          ...
          <div
            ...
            className={
              screenshots.length === 1
                ...
                : 'flex flex-row overflow-x-auto gap-4 px-6 py-4 -mx-6 [&::-webkit-scrollbar]:hidden [scrollbar-width:none] md:gap-8 md:px-8 md:pt-24 md:pb-4 md:-mx-8 md:[mask-image:linear-gradient(to_right,transparent_0%,black_3%,black_97%,transparent_100%)]'
            }
          >
          {screenshots.map((screenshot, index) => (
            <motion.div
              ...
              whileHover={{ scale: 1.15, transition: { duration: 0.4, ease: [0.34, 1.56, 0.64, 1] } }}
              transition={{ duration: 0.6, delay: index * 0.1 }}
              className={`relative aspect-[9/19] rounded-[2rem] overflow-hidden shadow-[0_10px_40px_rgba(0,0,0,0.12)] dark:shadow-[0_10px_40px_rgba(0,0,0,0.4)] md:hover:shadow-[0_20px_60px_rgba(0,0,0,0.2)] dark:md:hover:shadow-[0_20px_60px_rgba(0,0,0,0.6)] ring-1 ring-black/10 dark:ring-white/10 ${screenshots.length === 1 ? '' : screenshots.length === 2 ? 'w-[85vw] md:w-80 flex-shrink-0 md:-mt-20' : 'w-[85vw] md:w-64 flex-shrink-0 md:-mt-20'} md:cursor-pointer md:origin-bottom transition-shadow duration-300`}
            >
              <Image
